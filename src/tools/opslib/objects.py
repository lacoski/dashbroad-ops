...
class object_servers(object):
    ...
    def __init__(
        ...
        self.Name = s_Name
        self.Status = s_Status
        self.Image_id = s_Image_id
        self.Image_name = s_Image_name
        self.Flavor_id = s_Flavor_id
        self.Flavor_name = s_Flavor_name

    def show_server(self):
        print(
            "{Id} {Name} {Status} {Image_name} {Flavor_name}".format(
                Id = self.Id,
                Name = self.Name,
                Status = self.Status,
